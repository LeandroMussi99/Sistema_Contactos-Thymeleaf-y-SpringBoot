package lm.contactos.controlador;

import lm.contactos.modelo.Contacto;
import lm.contactos.servicio.ContactoServicio;
...
public class ContactoControlador {
    ...
    public String agregar(@ModelAttribute("contactoForma") Contacto contacto){
        ...
        return "redirect:/";//redirigimos al controlador el path "/" para que se recargue la lista
    }
